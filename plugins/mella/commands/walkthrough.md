...
description: Generate a step-by-step walkthrough guide for testing a new feature or bug fix. Auto-detects code changes from git or PR and creates thorough testing instructions.
model: sonnet
---
